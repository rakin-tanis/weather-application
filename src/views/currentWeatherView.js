      ...
      <div class="container d-flex justify-content-center">
        ...
        <div class="container d-flex flex-row tw-73">
          <div class="d-flex flex-row">
            ...
            <span id="${CURRENT_TEMPERATURE_ID}" style="font-size:6rem"></span>
          ...
          <div class="container-fluid d-flex flex-row justify-content-end">
            <div class="d-flex flex-column justify-content-center">
              <div id="${CURRENT_CITY_ID}" style="font-weight:bold; font-size:2rem;"></div>
              <div id="${CURRENT_DATE_ID}"></div>
              <div id="${CURRENT_DESCRIPTION_ID}"></div>
